          ...
          <div className={`anim-scale-in flex flex-col items-center gap-6 px-8 max-w-sm w-full text-center`} style={{ animationDelay: "0.1s" }}>
            ...
            {(phase === "title" || phase === "ai" || phase === "exit") && (
              <div className="anim-fade-up space-y-1" style={{ animationDelay: "0s" }}>
                <h1 className="text-5xl font-serif font-bold text-amber-50 tracking-wide drop-shadow-lg">ELGA Cafe</h1>
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-3">
                  ...
                  <div className="text-left">
                    <p lang="am" className="text-amber-50 font-ethiopic font-bold text-base leading-tight">እስራኤል በላይ</p>
                    <p className="text-amber-400/50 text-[10px] font-semibold tracking-widest uppercase">AI Hostess · ELGA Cafe</p>
                  </div>
                </div>
                <p lang="am" className="text-amber-100/90 text-base leading-relaxed font-light font-ethiopic">
                  {WELCOME_TEXT}
                </p>
              </div>
            )}

            <p lang="am" className="text-amber-200/25 text-xs mt-2 font-ethiopic">ለመቀጠል ይጫኑ</p>
          </div>
        )}
      </div>
    </>
      ...
      <div className={`min-h-screen bg-background ${menuMounted ? "menu-enter" : "opacity-0"}`}>
        ...
        <Dialog open={sentimentOpen} onOpenChange={setSentimentOpen}>
          <DialogContent className="max-w-sm text-center">
            ...
            <p className="text-muted-foreground text-sm mb-2">Tap to rate your visit at ELGA Cafe</p>
